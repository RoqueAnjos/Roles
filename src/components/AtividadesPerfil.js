...
const AtividadesPerfil = (props) =>{
            ...
            if(idUser==='')loadAllPosts();
                ...
                const loadOwnPosts = async ()=>{
                    ...
                    try{
                        ...
                        querySnapshot.forEach((doc) => {        
                            if(doc.data().user===idUser) loadedOwnPosts.push({ id: doc.id, ...doc.data() });
                        });
    ...
    return(
        <>
            ...
            :
            <View style={styles.role}>
                <Text style={{fontFamily: 'CircularSpotifyText-Book', textAlign: "center"}}>Nada para mostrar</Text>
            </View>
            }
        </>
    )
